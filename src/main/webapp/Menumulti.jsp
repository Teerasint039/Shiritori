        ...
        <div class="container">
            <div class="row justify-content-center" style="margin-top: 9%; color: white; font-family: Montserrat ExtraBold">
                    <div class="col-md-12 ">
                        ...
                        <span class="center" style="font-size:30pt; margin-left: 2%; margin-top: 2%;margin-right: 16rem;">Multi player</span>
                    </div>
                </div>
                    ...
                    <form>
                        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                            <div class="card-body d-flex flex-column align-items-start" >
                                <h3 class="mb-0">
                                    <strong class="d-inline-block mb-2 text-primary">Create room</strong>
                                </h3>
                                <input class="form-control" type="text" placeholder="Name room" style="margin-top: 2%;"> 
                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" style="margin-top: 2%;">
                    ...
                    <form>
                        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                            <div class="card-body d-flex flex-column align-items-start" >
                                ...
                                <button type="submit" class="btn btn-success" style="margin-top: 5%;">Submit</button>
                            </div>
