    ...
    <body class="text-center">
        ...
        <div class="background">
            ...
            <div class="container d-none d-md-block">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-6">
                        <img src="Icon/Cardanimal/card bear.png" class="img-fluid" alt="Responsive image" style="width: 15rem; margin-top: 5%;">
                    </div>
                </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-auto" style="color: white; margin-top: 2%;"> 
                        <p class="text-center">
                        <h2>Center aligned text on all viewport sizes.</h2>
                        </p>
                    </div>
                </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="col col-md-12">
                        ...
                        <button type="button" class="btn btn-outline-light rounded-circle border-0"  id="start-record-btn" style="margin-top: 3%; width: 8rem; height: 8rem;" data-toggle="modal" data-target="#exampleModalCenter">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Correct</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <img src="Icon/popupcorrect.png" class="img-fluid" alt="Responsive image" style=" width: 30rem;">
                                    </div>
                                </div>
                            </div>
                        </div>
